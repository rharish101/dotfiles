...
This is a repository containing all of my configurations of my current rice. I
use [GNU Stow](https://www.gnu.org/software/stow/) to manage my dotfiles (for a
tutorial,
[click here](https://alexpearce.me/2016/02/managing-dotfiles-with-stow/)).
...
- [GNU Stow](https://www.gnu.org/software/stow/) - tool used for managing
  dotfiles
- Hyprland plugins:
...
- Fish config:
  ...
  - [Cowsay](https://github.com/tnalpgge/rank-amateur-cowsay) - tool for making
    Tux say the random adages
  - [Dotacat](https://gitlab.scd31.com/stephen/dotacat) - tool for colouring Tux
    saying the random adages
- Themes and fonts:
  - [vimix-dark-beryl](https://github.com/vinceliuice/vimix-gtk-themes) - GTK
    theme
  - [VimixBerylDark](https://github.com/vinceliuice/vimix-kde) - Kvantum theme
    (for Qt applications)
  - [Papirus-Dark](https://github.com/PapirusDevelopmentTeam/papirus-icon-theme) -
    icon theme
  - [papirus-folders](https://github.com/PapirusDevelopmentTeam/papirus-folders) -
    tool for setting folder icon colours
  - Breeze Light (from KDE Plasma) - cursor theme
  - [Roboto](https://fonts.google.com/specimen/Roboto) - font
  - [JetBrainsMono](https://www.jetbrains.com/lp/mono/)
    [Nerd Font](https://github.com/ryanoasis/nerd-fonts) - monospace font
...
For my NeoVim setup, use Stow on the `config` folder inside the `nvim` folder as
follows:
...
Further instructions can be found in the README of that repo:
<https://github.com/rharish101/vim-config>.

### Papirus Folders

Run the following command to set the folder colors of the Papirus-Dark theme to
match the Vimix GTK theme's colorscheme:
...
2. Install all plugins:
   ...
   fisher update
   ```
3. Follow the configure wizard of tide to set up your prompt the way you want
...
![fish-1](./screenshots/fish-1.png) ![fish-2](./screenshots/fish-2.png)
...
![nvim-1](./screenshots/nvim-1.png) ![nvim-2](./screenshots/nvim-2.png)
...
The MIT license is placed in [LICENSE](./LICENSE), to signify that it
constitutes the majority of the codebase, and for compatibility with GitHub. All
screenshots are under the
